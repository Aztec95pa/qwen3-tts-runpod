...
## Service API (Local Voice AI)

This repository now supports a local service mode for quick product-like deployment:

- API server: `qwen-tts-service` (FastAPI)
- Endpoints:
...
- Browser UI: `/ui` (simple client)

See `VOICE_SERVICE_GUIDE.md` for step-by-step setup, Firebase integration, and production notes.
